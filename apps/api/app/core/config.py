...
class Settings(BaseSettings):
    ...
    # ── PostgreSQL ─────────────────────────────────────────
    # Default matches the local Docker Compose service 'db'. Override via .env for other environments.
    database_url: str = "postgresql+asyncpg://regiq_user:regiq_password@db:5432/regiq_db"
